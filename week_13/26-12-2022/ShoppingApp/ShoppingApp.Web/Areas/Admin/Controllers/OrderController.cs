...
namespace ShoppingApp.Web.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            List<OrderListDto> ordersListDtos = new List<OrderListDto>();
            ...
            foreach (var order in orders) 
            {
                orderListDto = new OrderListDto
                {
                    ...
                    OrderListItems=order.OrderItems.Select(oi=>new OrderListItemDto
                    {
                        ...
                        Price= oi.Price,//satış yapıldıgındaki price
                ...
                ordersListDtos.Add(orderListDto);
            }
            ViewBag.Title = "Tüm Siparişler";
            return View(ordersListDtos);
        }
    }
}
