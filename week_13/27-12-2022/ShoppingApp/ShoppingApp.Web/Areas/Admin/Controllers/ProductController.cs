...
namespace ShoppingApp.Web.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public ProductController(IProductService productService, ICategoryService categoryService, IProductService productManager)
        {
        ...
        {
            //Arama kriterleirne göre ürün vericek
            var products = searchQueryDto!=null ? await
            _productService.GetSearchResultsAsync(searchQueryDto.IsApproved,searchQueryDto.IsHome,searchQueryDto.SearchString) :
                await _productService.GetProductsWithCategories();
