...
namespace ShoppingApp.Data.Concrete.EfCore.Repositories
{
    public class EfCoreProductRepository : EfCoreGenericRepository<Product>, IProductRepository
    {
        ...
        {
            var result = ShopAppContext.Products.AsQueryable();//productı sorgulanabilr şekilde al demeki
            if (isApproved!=null)
            {
                //nullse product olarak kalır true ise onaylı olur false ise false olanları onaysız ları getiiri
            ...
            if (!String.IsNullOrEmpty(searchString))
            {
                ...
                p.Description.ToLower().Contains(searchString.ToLower())).AsQueryable();
            }
