    ...
    public class KitabeviContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Kitap>()
                .HasData(
                    new Kitap() {Anasayfa=true, Id = 1, Ad = "İnsanlar", BasimYili = 2021, SayfaSayisi = 330, KategoriId = 2, YazarId = 1,Ozet=" Lorem, ipsum dolor sit amet consectetur adipisicing elit. A id cupiditate officia. Odit laborum fuga sed accusamus quia inventore, explicabo porro error recusandae aliquam repellat itaque libero blanditiis aperiam fugiat!" },
                    ...
                    new Kitap() { Id = 6, Ad = "19", BasimYili = 2016, SayfaSayisi = 380, KategoriId = 2, YazarId = 6,Ozet=" Lorem, ipsum dolor sit amet consectetur adipisicing elit. A id cupiditate officia. Odit laborum fuga sed accusamus quia inventore, explicabo porro error recusandae aliquam repellat itaque libero blanditiis aperiam fugiat!" },
