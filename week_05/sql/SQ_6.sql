...
/*
	Ýþçi,MuhasebeUzmaný,Satýþcý,ÝK Uzamaný,ÝK Stajyeri
...
INSERT INTO Personeller(ad,soyad,cinsiyet,dogumTarihi,ikametgahIlceId,iseBaslamaTarihi,departmanId,unvanId,maas) VALUES
	...
	('Armanc','Elþisurat',1,'1999-05-15',6,'2021-11-10',1,6,17500),
	('Kadriye','Ýpekçeken',1,'1999-05-15',7,'2021-11-10',2,5,15500),
	('fatih','Elebakan',0,'1999-05-15',1,'2021-11-10',3,4,18500),
	('kaya','kurtultepe',0,'1999-05-15',2,'2021-11-10',5,3,19500),
	('selcuk','tepe',0,'1999-05-15',3,'2021-11-10',5,2,16500),
...
INSERT INTO Projeler(ad,baslamaTarihi,planlananBitisTarihi) VALUES
	('Mutlu çoçuklar','2022-5-5','2022-8-5'),
	('Temiz Üsküdar','2022-5-5','2022-8-5'),
	('Kirli Kadýköy','2022-5-5','2022-8-5'),
	('Haydi çoçuklar','2022-5-5','2022-8-5')