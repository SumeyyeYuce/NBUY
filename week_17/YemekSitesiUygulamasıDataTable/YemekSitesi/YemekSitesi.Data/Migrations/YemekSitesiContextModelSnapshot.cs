...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "50e9757c-2db4-4f5f-b2d7-66df5c94a4f4",
                            RoleId = "85686fee-c625-4633-b6e4-92d689ebeaa4"
                        },
                        new
                        {
                            UserId = "5fba242a-3d85-412d-82b9-03982f2ce6d2",
                            RoleId = "d18be69e-0c02-48b6-bdd6-899d4078b978"
                        });
                });
            ...
            modelBuilder.Entity("YemekSitesi.Entity.Concrete.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("YemekSitesi.Entity.Concrete.Favorite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("YemekSitesi.Entity.Concrete.FavoriteItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("YemekSitesi.Entity.Concrete.Identity.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "85686fee-c625-4633-b6e4-92d689ebeaa4",
                        ...
                        new
                        {
                            Id = "d18be69e-0c02-48b6-bdd6-899d4078b978",
            ...
            modelBuilder.Entity("YemekSitesi.Entity.Concrete.Identity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "50e9757c-2db4-4f5f-b2d7-66df5c94a4f4",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "956805d2-38e8-4064-8843-a0291089319f",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEAlCvmGKegyXjmNopTWmdUioFoa++gmpUntjBlt8e6SaLv41NurhQ124TFJTNvP1uA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "74ef2e73-f340-4f7c-9c1b-92da0e49ec4d",
                            TwoFactorEnabled = false,
                            UserName = "admin"
                        },
                        new
                        {
                            Id = "5fba242a-3d85-412d-82b9-03982f2ce6d2",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ace00117-c96a-4284-a123-eb68103c2ee4",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAELMFP3wyGswHHh2nD7aDsjcwPYcrebCKmjvnyNPOMIP7aE9Vf0UrT30QQHuOJZOyZQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "69dfcf9a-2771-4791-bf82-098f392cbf76",
                            TwoFactorEnabled = false,
                            UserName = "user"
                        });
                });
            ...
            modelBuilder.Entity("YemekSitesi.Entity.Concrete.Comment", b =>
                {
                    ...
                    b.HasOne("YemekSitesi.Entity.Concrete.Identity.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("YemekSitesi.Entity.Concrete.FavoriteItem", b =>
                {
                    b.HasOne("YemekSitesi.Entity.Concrete.Favorite", "Favorite")
