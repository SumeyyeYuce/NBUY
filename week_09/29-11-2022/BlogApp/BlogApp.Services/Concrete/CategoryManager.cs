...
namespace BlogApp.Services.Concrete
{
    public class CategoryManager : ICategoryService
    {
        ...
        {
            var categories = await _unitOfWork.Categories.GetAllAsync(null,c=>c.Articles);//bütün verileri article la beraber veritabanından çek(kategori tipinde liste döndrüor)
            if (categories.Count>0)//buraya bir kategori gelmişse
            {
        ...
        public async Task<IDataResult<CategoryListDto>> GetAllByNonDeleted()//aktif pasif için
        {
