    ...
    public class UserMap : IEntityTypeConfiguration<User>
    {
        public void Configure(EntityTypeBuilder<User> builder)
        {
            ...
            builder.Property(u => u.Email)
                .IsRequired()
                .HasMaxLength(50);
            builder.HasIndex(u => u.Email).IsUnique();//bu benzersiz deger özelliğini verir.Aynı emailden başka biratane daha olamaaz
            ...
            builder.HasData(
                new User
                {
                    ...
                    PasswordHash =Encoding.ASCII.GetBytes("200820e3227815ed1756a6b531e7e0d2")//qwe123 şifrenin has lenmiş hali
                },
                 new User
                 {
                     Id = 2,
                     ...
                     PasswordHash = Encoding.ASCII.GetBytes("46f94c8de14fb36680850768ff1b7f2a")//123qwe şifrenin has lenmiş hali
                 });
        }
    }
}
