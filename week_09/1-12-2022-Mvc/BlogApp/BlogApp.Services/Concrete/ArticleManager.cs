...
namespace BlogApp.Services.Concrete
{
    public class ArticleManager : IArticleService
    {
        ...
        {
            //2.işlem burası -> articleProfile
            var article = _mapper.Map<Article>(articleAddDto);//dışarıdan gelen articledto yu article tipinde bir nesnye  dönüştür al bu değişkene koy
            article.CreatedByName=createdByName;
            article.ModifiedByName=createdByName;
            article.UserId = 1;
            #region Açıklamalar
            //userıd yişimdilik elle veriyoruz login işlemleri tammaladnığında burası değişicek
            //eger entitybase içinde cretaedDate için defalut deger vermemiş olsaydık buşekilde yapabilirdik
            //ikinci bir yolu profile içinde deger vermektir
        ...
        {
            //4.işlem burası -> categoryler için aynı işlemi uygula.
