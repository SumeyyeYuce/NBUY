...
namespace YemekSitesi.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterDto registerDto)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(user.Email, "YemekSitesi Hesap Onaylama", $"<h1>Merhaba</h1><br><p>Lütfen hesabınızı onaylamak için aşağıdaki linke tıklayınız.</p><a href='https://localhost:5052{url}'>Onay linki</a>");
                    TempData["Message"] = Works.PushMessage("Bilgi", "Lütfen mail hesabınızı kontrol edin. Gelen linki tıklayarak, hesabınızı onaylayın.", "warning");
        ...
        public async Task<IActionResult> ConfirmEmail(string userId, string token)
        {
            ...
            {
                TempData["Message"] = Works.PushMessage("Hata", "Geçersiz token ya da user bilgisi.", "danger");
                return View();
            }
